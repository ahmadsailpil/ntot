...
*❏ limit:* ${limit}
`
conn.send2ButtonImg(m.chat, await (await fetch(res)).buffer(), caption, watermark, 'AutoLevelup', '.on autolevelup', 'BUY', '.buy', m)
} 
    
    }
handler.help = ['rank', 'rankcard', 'levelrank']
handler.tags = ['info']
handler.command = /^(rank|rankcard|levelrank)$/i
